...
export default function card({avatar, uname, uid, sign, number, selected, dead, winner, enableSignUp, onClick}) {
    return <div className={`poker-card ${dead ? 'dead' : 'unselected'} ${winner ? 'win' : ''} ${(enableSignUp || dead) ? 'show' : ''}`} onClick={onClick}>
